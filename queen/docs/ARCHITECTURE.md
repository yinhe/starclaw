...
| **Starter** | ≤20 | 3 | + 用量统计 + 基础告警 | ¥500/月 |
| **Pro** | ≤100 | 不限 | + SSO + 审计 + 高级分析 + 模型路由 | ¥2,000/月 |
| **Enterprise** | ≤1000 | 不限 | + 合规面板 + SLA + 专属技术支持 | ¥10,000/月 |
| **White-Label** | 定制 | 不限 | + 品牌全套替换 + 功能开关 + 自定义域名 | ¥20,000/月 + 定制费 |
