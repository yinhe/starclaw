...
```
           ...
           ┌──────────┼──────────┐
           ▼          ▼          ▼
      合伙人 A    合伙人 B    合伙人 C        ← Partner Overlord (利润分成)
        │            │           │
    ┌───┼───┐    ┌───┘      ┌───┼───┐
    ▼   ▼   ▼    ▼          ▼   ▼   ▼
   代理 代理 代理  代理       代理 代理 代理    ← Agent Overlord (佣金制)
    │   │   │    │          │   │   │
    ▼   ▼   ▼    ▼          ▼   ▼   ▼
...
| 收入类型 | 合伙人 | 平台 (Queen) | 说明 |
|---------|:------:|:----------:|------|
| 节点订阅费 | **70%** | 30% | 合伙人自主定价，平台只收底价 |
| 星能消耗费 | **60%** | 40% | 算力成本较高，平台多留 |
| 增值服务费 | **85%** | 15% | 合伙人自己交付的服务 |
| **综合平均** | **~70%** | **~30%** | |

> 举例：合伙人签了 ¥10,000/月客户 → 合伙人到手 ~¥7,000/月，平台 ~¥3,000/月

**场景 B：代理签客户 — 三级分成**

```
企业客户 ──付费──→ 代理（一线收款）──分润──→ 合伙人（上级）──分润──→ 平台
```

| 收入类型 | 代理 | 合伙人（上级） | 平台 (Queen) |
|---------|:----:|:----------:|:----------:|
| 节点订阅费（**首年**） | **40%** | **30%** | 30% |
| 节点订阅费（**续费**） | **25%** | **20%** | 55% |
| 星能消耗费 | **30%** | **20%** | 50% |
...
> 设计逻辑：首年代理拿多（激励拓新）；续费平台多留（产品驱动留存）；合伙人始终有份（激励招募管理代理）

> 举例（首年）：代理签 ¥10,000/月客户 → 代理 ~¥4,000 + 合伙人 ~¥3,000（躺赚）+ 平台 ~¥3,000

**阶梯激励 — 合伙人量大优享：**

| 合伙人月度总流水 | 合伙人分成 | 平台分成 | 等级 |
|:-------------|:--------:|:------:|------|
| < ¥50,000 | 70% | 30% | 🥉 铜级领主 |
...
| 打款时间 | 每月 10 号前打款 |
| 最低提现 | ¥500 |
| 税务 | 合伙人/代理自行处理税务（平台提供佣金明细） |
| 客户保护期 | 代理签约客户 12 个月内不可被其他代理抢走 |
| 退款处理 | 客户退款则等比扣回已发佣金 |
...
| **Overlord Partner** | 无限 | Enterprise + 代理管理 + CRM + 分润 | 利润分成 |
