...
const CATEGORY_TAG_MAP: Record<string, string[]> = {
  '推荐': [],
  '创意内容': ['创作', 'mv', 'music', 'video', 'comic', '短剧', '导演', '漫剧'],
  '编程开发': ['编程', 'code', 'coding', 'fullstack', 'Python', 'Java', '前端', 'React', '数据库', 'API', '小程序', '算法', '测试'],
  '商业办公': ['商业', 'business', '产品', '办公', 'BP'],
  '教育培训': ['教育', '高考', '考研', '雅思', '辅导', '公务员', '留学', '早教', '职业资格'],
  '金融财经': ['股票', '基金', '财报', '理财', '税务', '保险', '量化', '风控', '区块链', '估值', '财经', '外汇', '金融'],
  '医疗健康': ['健康', '中医', '心理', '营养', '健身', '医学', '药物', '育儿', '慢性病', '急救', '医疗'],
  '法律合规': ['合同', '劳动法', '知识产权', '公司法', '婚姻', '刑事', '房产', '隐私', '法律', '维权', '法务'],
  '营销推广': ['小红书', '抖音', '品牌', 'SEO', '广告', '社群', '公关', '活动', '私域', 'KOL', '增长', '营销'],
  '电商零售': ['淘宝', '天猫', '拼多多', '跨境', '直播', '详情页', '供应链', '定价', '选品', '电商'],
  '人力资源': ['简历', '面试', '薪酬', '绩效', '培训', '招聘', '组织架构', 'HRBP', 'HR', '人力'],
  '客户服务': ['客服', '投诉', 'FAQ', '工单', '满意度', '话术', 'VIP', '退换货', '客户成功'],
  '翻译语言': ['翻译', '中英', '日语', '韩语', '字幕', '本地化'],
  '写作创作': ['公众号', '网文', '新闻稿', '简历', '广告文案', '影评', '演讲', 'PPT', '邮件', '写作'],
  '通用助手': ['日程', '会议', '读书', '旅行', '美食', '生活', '情感', '政策', 'Excel', 'AI工具', '英语口语'],
};
...
const TYPE_META: Record<MarketType, { title: string; desc: string; categories: string[] }> = {
  agents: {
    ...
    categories: ['全部', '推荐', '创意内容', '编程开发', '商业办公', '教育培训', '金融财经', '医疗健康', '法律合规', '营销推广', '电商零售', '人力资源', '客户服务', '翻译语言', '写作创作', '通用助手'],
  },
  skills: {
    title: '技能市场',
