...
// CreditAccount tracks a claw node's star energy balance (星能账户)
type CreditAccount struct {
	...
	Balance    int64     `json:"balance" gorm:"default:0"`                          // 可用余额，单位：最小星能（1 Star = 10000 units）
...
// CreditTransaction records every star energy change (星能交易流水)
