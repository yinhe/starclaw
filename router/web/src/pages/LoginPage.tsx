...
export default function LoginPage() {
  ...
  async function handleClawLogin() {
    ...
    try {
      ...
      // Step 2: Get challenge from star-ai
      const { challenge } = await clawAuth.challenge();

      // Step 3: Send auth-request to Claw (creates pending request for user to approve)
        ...
        pollRef.current = setInterval(async () => {
          ...
          try {
            ...
            if (status.status === 'approved') {
              ...
              // Step 5: Submit signature to star-ai for verification
              setStep('verifying');
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-5">
          ...
          <p className="text-center text-xs text-gray-600 pt-1">
            没有 Claw 节点？<a href="https://github.com/yinhe/starclaw" target="_blank" rel="noopener noreferrer" className="text-amber-500 hover:underline">免费部署一个</a>
          </p>
        </div>
