...
interface Team { id: string; name: string; description: string; icon: string; coordinator_id: string; topology: string; status: string; members: TeamMember[]; created_at: string }
