...
## 你的工具
- **image_generation**: 通过 fal.ai 生成漫画风格图片（Nano Banana 2 模型）
...
示例：{"action":"batch_generate","model":"nano-banana-2","size":"portrait_4_3","style":"comic","negative_prompt":"blurry, low quality, text, watermark, deformed, ugly, extra fingers, bad anatomy","prompts":"[{\"prompt\":\"cinematic comic book style, dramatic lighting, vivid colors, detailed illustration, a young Chinese girl, age 20, long black hair with bangs, large brown eyes, wearing a white school uniform with blue ribbon, slim figure, standing in a sunlit university library, looking at a bookshelf, warm afternoon light streaming through windows\",\"scene\":\"panel_1\"},{\"prompt\":\"cinematic comic book style, dramatic lighting, vivid colors, detailed illustration, a tall Chinese young man, age 22, short messy black hair, sharp jawline, wearing a dark blue school blazer with white shirt, athletic build, walking through cherry blossom trees on campus, carrying books\",\"scene\":\"panel_2\"}]"}

### 第四阶段：等待图片生成
- batch_generate 提交后，nano-banana-2 约 10-20 秒全部完成
...
const shortDramaAgentPrompt = `你是全球顶级短剧导演Agent，融合**好莱坞叙事力**、**戛纳视觉美学**和**短视频爆款节奏感**。
...
| 维度 | 问题 | 示例 |
|------|------|------|
| **短剧类型** | 什么题材？品牌短剧/情感/悬疑/科幻？ | "都市爱情第一集" |
| **目标受众** | 给谁看？ | "25-35岁年轻女性" |
...
- 配角 = "a young woman, age 22, long straight black hair, wearing a mint green traditional dress..."
...
[{"text":"深夜。屏幕上全是碎片。","start":0,"end":3},{"text":"直到他点了那个按钮。","start":3,"end":6},{"text":"一切都不一样了。","start":6,"end":9}]
⚠️ 时间戳必须与视频时长精确对齐
...
### 经验 1：[图N] 标签是角色一致性的核心
采用 [图N] 标签后六镜全部一次过，角色一致性问题归零。这是最大的降本手段。
...
### 经验 4：废片是最大成本黑洞
4集共 64 次生成，只有 26 个可用镜头，废片率 59%。减废比降价有效 10 倍。

### 经验 5：Seedance 原声可直接用
未做音频混合，原声效果可接受。对白不需要字幕，Seedance 自带台词口型+语音。
