...
func (h *ForgeHandler) UpdateProject(c *gin.Context) {
	...
	if req.NydusRepo != nil { updates["nydus_repo"] = *req.NydusRepo }
...
func (h *ForgeHandler) UpdateIssue(c *gin.Context) {
	...
	if req.AssigneeNode != nil { updates["assignee_node"] = *req.AssigneeNode }
	if req.MilestoneID != nil { updates["milestone_id"] = *req.MilestoneID }
	if req.SprintID != nil { updates["sprint_id"] = *req.SprintID }
	if req.MissionID != nil { updates["mission_id"] = *req.MissionID }
	if req.PRNumber != nil { updates["pr_number"] = *req.PRNumber }
	if req.Branch != nil { updates["branch"] = *req.Branch }
	if req.Labels != nil { updates["labels"] = *req.Labels }
	if req.StoryPoints != nil { updates["story_points"] = *req.StoryPoints }
